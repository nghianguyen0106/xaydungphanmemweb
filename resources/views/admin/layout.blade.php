    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"> {{ Session::get('adminname')}} </span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                <li><a href="{{URL::to('/logoutad')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/admin-qlnv')}}">Nhân viên</a></li>
                        <li><a href="{{URL::to('/admin-qlkh')}}">Khách hàng</a></li>
                    </ul>
                </li>
            <li>
                    <a class="active" href="{{ URL::to('order')}}">
