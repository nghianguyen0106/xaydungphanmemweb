  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      <div class="col-sm-5 m-b-xs">
        <a href="{{URL::to('addmember')}}" class="btn btn-success" >Thêm khách hàng</a>
        ...
        <tbody  style="text-align:  center;">
          ...
          <tr>
            ...
            <td>{{$v->email}}</td>
              ...
              <td>
               <a href="{{URL::to('editmem/'.$v->khMa)}}" class="active" ui-toggle-class=""><i class="fa far fa-edit"></i></a>&nbsp;<a href="{{URL::to('deletemeber/'.$v->khMa)}}" ><i class="fa fas fa-trash" style="color: red;"></i></a>
            </td>
          </tr>
            @endforeach
